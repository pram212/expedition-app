...
class OrderController extends Controller
{
    ...
    public function create()
    {
        ...
        return view('crm.order.FormOrder', compact('districts', 'categories', 'shipmentStatus', 'paymentStatus'));
    }
    ...
    public function edit($id)
    {
        ...
        return view('crm.order.FormOrder', compact('districts', 'categories', 'shipmentStatus', 'paymentStatus', 'order', 'villages'));
    }

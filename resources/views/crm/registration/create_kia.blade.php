...
<head>
    ...
    <title>Pendaftaran KIA</title>
</head>

<body>
    <div class="container-fluid p-2">
        <form action="{{ url('/pendaftaran/kia') }}" method="POST">
            @csrf
            <div class="card card-primary">
                <div class="card-header text-center">
                    <h1>Pendaftaran KIA</h1>
                    <p>Formulir permohonan untuk pengiriman dokumen kartu induk anak</p>
                    ...
                    <div class="card card-danger">
                        ...
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="col-sm-12 col-md-6">
                                    <div class="form-group">
                                        <label for="customer_name">Nama Anak : <span
                                                class="text-danger">*</span></label>
                                        <input type="text" name="customer_name" id="customer_name"
                                            class="form-control @error('customer_name') is-invalid @enderror"
                                            placeholder="Isi Nama sesuai KIA" aria-describedby="helpId"
                                ...
                                <div class="col-sm-12 col-md-6">
                                    <div class="form-group">
                                        <label for="customer_guardian">Nama Orangtua/Wali : <span
                                                class="text-danger">*</span></label>
                                        <input type="text" name="customer_guardian" id="customer_guardian"
                                            ...
                                            placeholder="Isi Nama orangtua/wali" aria-describedby="helpId"
                                            value="{{ old('customer_guardian') }}">
                                ...
                                <div class="col-sm-12 col-md-6">
                                    <div class="form-group">
                                        <label for="phone">Nomor WA Aktif : <span
                                                class="text-danger">*</span></label>
                    ...
                    <div class="card card-danger">
                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col-sm-12 col-md-6">
                                    <div class="form-group">
                                        <label for="district_id">Kecamatan : <span
                                                class="text-danger">*</span></label>
                                ...
                                <div class="col-sm-12 col-md-6">
                                    <div class="form-group">
                                        <label for="village_id">Kelurahan/Desa : <span
                                                class="text-danger">*</span></label>

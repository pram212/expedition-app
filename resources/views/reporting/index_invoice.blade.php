    ...
    <div class="card">
        ...
        <div class="card-body">
            <form action="">
                <div class="row">
                    ...
                    <div class="col-md-12 col-12 text-center">
                        ...
                        <a href="{{ url('/invoice') }}" class="btn m-1 btn-warning">Reset</a>
                        <button type="button" class="btn btn-secondary m-1" id="print-multiple">Cetak Banyak</button>
                    </div>
                </div>
            </form>
            <form action="{{ url('/invoice/multiple/print') }}" target="_blank" id="form-invoice">
                <div class="row">
                    <div class="col-12">
                        <input type="hidden" name="ids_order" id="ids_orders">
                    </div>
                </div>
            </form>
        </div>
                ...
                <tbody>
                    @forelse ($orders as $order)
                        <tr>
                            ...
                            <td>
                                <a href="{{ url("invoice/print/$order->id") }}" target="_blank"
